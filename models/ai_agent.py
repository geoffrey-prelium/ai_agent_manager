...
class AiAgent(models.Model):
    ...
    def execute_action(self, record, action_code):
        ...
        system_instruction = (
            ...
            "1. You CANNOT use 'import' statements (e.g., `import datetime` will crash). 'datetime', 'time', and 'dateutil' are ALREADY available natively in your execution context. Just use `datetime.date.today()`.\n"
        ...
        self.env['ai_manager.log'].create({
            ...
            'state': state,
            'output_data': execution_log.strip(),
